            ...
            {/* user based menues */}
            {
                role ?
                    ...
                    <>
                        <div className="flex flex-col justify-start items-start px-4">
...

                            {
                                dashboardRout?.map(route =>
                                    ...
                                    <NavLink key={route.link} to={route.link} className={({ isActive }) => ` w-full py-2 transition-all duration-200 ${isActive ? 'bg-primary rounded-md text-accent' : ''}`}>
                        ...
                        <div className="w-full flex flex-col justify-start  items-center md:items-start gap-4 pt-4 pl-4">
                            <h4 className="uppercase font-semibold text-gray-500 text-xs ">Controls</h4>
                            {
                                defaultRoutes?.map(item =>
                                    <NavLink
                                        key={item.link}
                                        to={item.link}
                                        className={({ isActive }) => ` w-full py-2 transition-all duration-200 ${isActive ? 'bg-primary rounded-md text-accent' : ''}`}>
                                        <div className="flex items-center justify-center md:justify-start gap-2">
